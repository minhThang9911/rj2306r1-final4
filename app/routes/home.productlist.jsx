...
export const loader = async () => {
	const productList = (await fetcherServer.get(api.link.products)).data;
	const vendorList = (await fetcherServer.get(api.link.vendors)).data;
		...
		() => [
			{
				...
				renderCell: (param) => {
					return (
						<img src={param.row.thumbnail} alt={param.row.title} />
					);
				},
			},
