	...
	return (
		<div class="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12 relative">
			<button
				...
				class="bg-green-500 text-white rounded-md px-2 py-1 absolute top-5 right-5 block w-40 hover:bg-green-400 hover:scale-110">
					...
					<div class="max-w-md mx-auto">
						...
						<div class="divide-y divide-gray-200">
							<div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
								...
								<div class="relative">
									<button class="bg-blue-500 text-white rounded-md px-2 py-1 hover:bg-blue-400 hover:scale-110">
